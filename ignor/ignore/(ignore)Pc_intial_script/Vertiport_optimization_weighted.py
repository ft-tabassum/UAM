...
# functions for Layout similarity ignor: the stability of centroid positions (distance matrix)
...
# function for probability similarity ignor
...
def analyze_weight_skewness(weights, iteration, save_dir):
    ...
    # 3. Q-Q plot for normality ignor
...
for iteration in range(max_iter):
    ...
    if iteration == 0:
        ...
        # No convergence ignor needed for first iteration
