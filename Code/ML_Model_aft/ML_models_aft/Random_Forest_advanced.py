...
data = pd.read_csv("D:/Thesis/UAM/Result/MachineLearning_model/aft_advanced_features.csv")
...
param_grid = {
    ...
    'classifier__max_depth': [10, 15, 20],  # Deeper trees
...
all_fold_probs_df.to_csv('D:/Thesis/UAM/Result/ML_Model/Probabilities/Training_Probabilities/all_folds_probabilities_RandomForest.csv', index=False)
...
test_probs_df.to_csv('D:/Thesis/UAM/Result/ML_Model/Probabilities/Testing_Probabilities/test_set_probabilities_RandomForest.csv', index=False)
...
feature_importance_df.to_csv('D:/Thesis/UAM/Result/ML_Model/Feature_Importance/feature_importance_RandomForest.csv', index=False)

# Save results
with open('D:/Thesis/UAM/Result/ML_Model/Prediction_EvaluationMetrics/Result_RandomForest.txt', 'w') as f:
...
conf_matrix_df.to_csv('D:/Thesis/UAM/Result/ML_Model/Confusion_Matrix/CM_RandomForest.csv', index=True)
