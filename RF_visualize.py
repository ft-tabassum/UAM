...
conf_matrix_df = pd.read_csv('confusion_matrix_RandomForest.csv', index_col=0)
conf_matrix_sum = conf_matrix_df.values

# Load feature importance CSV
feature_importance_df = pd.read_csv('feature_importances_RandomForest.csv')

# Load predicted probabilities + labels CSV
prob_df = pd.read_csv('predicted_probabilities_RandomForest.csv')
